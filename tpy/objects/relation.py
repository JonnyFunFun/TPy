...
from tpy.objects.relationtype import RelationType


class Relation(TargetProcessEntity):
    ...
    fields = {
            ...
            "Master"        : TargetProcessField(type='link',obj=General),
            "Slave"         : TargetProcessField(type='link',obj=General),
			"RelationType"  : TargetProcessField(type='link',obj=RelationType)
    }