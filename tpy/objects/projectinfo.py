...
from tpy.objects import processinfo, programinfo

class ProjectInfo(TargetProcessEntity):
    ...
    fields = {
			...
			"Process"	: TargetProcessField(type='link',obj=ProcessInfo),
			"Program"	: TargetProcessField(type='link',obj=ProgramInfo)
    }
